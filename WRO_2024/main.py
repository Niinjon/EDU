...
class KDIErobot(DriveBase):
    def __init__(self, balmotor, jobbmotor, kerekatmero, tengelytav, gyroport, tengelyelore):
        ...
        self.distance_control.pid(240, 150, 3, 3, 1, 0) #80, 150, 10, 20, 4, 0 160, 150, 3, 10, 1, 0
    ...
    def gyroturn(self, angle):
        ...
        ciklusatlag_tavolsag = 0.26 #0.26 #0.5 volt
...
def kupak():
    #fogo.run_until_stalled(-100)
    fogo.run_time(-100, 1000, Stop.HOLD, False)
    emelo.run_angle(-150, 70)
...
balmotor = Motor(Port.B, Direction.COUNTERCLOCKWISE)
jobbmotor = Motor(Port.C, Direction.COUNTERCLOCKWISE)
#jobbmotor.control.limits(2000, 4000)
#balmotor.control.limits(2000, 4000)
#jobbfenysensor = ColorSensor(Port.S1)
#balfenysensor = ColorSensor(Port.S3)
emelo = Motor(Port.A)
fogo = Motor(Port.D)
gyro = GyroSensor(Port.S3)
#htcolor = HitechnicSensor(Port.S2)
kerekatmero = 62.4 #62.4 kisfekete #87 nagykék  100.6 cross gumi 
tengelytav = 200
tengelyelore = 50
...
'''
driftel=False
drifttimer=StopWatch()
drifttimer.reset()
while drifttimer.time()<1000:
    drift = robot2.gyro.speed()
    if drift != 0:
        driftel=True
        break
wait(100)
drift = robot2.gyro.angle()
drift = robot2.gyro.angle()
wait(100)
...
#emelo.run_until_stalled(-100, Stop.HOLD)
#robot2.gyroturn(-270)
...
robot2.haromszogszamitas(robot2.aktualx, robot2.aktualy + 50, 'y')
robot2.haromszogszamitas(1484, 538, 'y')
fogo.run_until_stalled(-100, Stop.HOLD, 50)
robot2.haromszogszamitas(1150, 255)
fogo.run_angle(100, 40)
robot2.elore(85)
fogo.run_until_stalled(-100, Stop.HOLD, 70)
robot2.haromszogszamitas(2099, 780, 'y')
robot2.szogrefordulas(-90)
fogo.run_time(-100, 1000, Stop.HOLD, False)
emelo.run_angle(-150, 70)
robot2.elore(100)
fogo.run_angle(100, 100)
robot2.haromszogszamitas(790, 150)
robot2.szogrefordulas(-110)
emelo.run_angle(150, 70)
fogo.run_angle(100, 40)
robot2.elore(250)
fogo.run_until_stalled(-100, Stop.HOLD, 70)
robot2.szogrefordulas(-90)
robot2.elore(250)
robot2.haromszogszamitas(2130, 760)
robot2.szogrefordulas(-90)
fogo.run_time(-100, 1000, Stop.HOLD, False)
emelo.run_angle(-150, 70)
robot2.elore(140)
fogo.run_angle(100, 200)
robot2.haromszogszamitas(125, 435)
robot2.szogrefordulas(-90)
robot2.elore(150)
emelo.run_until_stalled(100, Stop.BRAKE, 50)
fogo.run_until_stalled(-100, Stop.HOLD, 70)
robot2.haromszogszamitas(1000, 650)
robot2.haromszogszamitas(2140, 290)
fogo.run_until_stalled(100, Stop.HOLD, 50)
robot2.tolatas(100)
robot2.haromszogszamitas(450, 960, 'y')
robot2.szogrefordulas(-180)
robot2.elore(100)
fogo.run_until_stalled(-100, Stop.HOLD, 70)
robot2.haromszogszamitas(1020, 660)